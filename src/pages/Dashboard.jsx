  ...
  const topProductsData = useMemo(() => {
    ...
    return {
      ...
      datasets: [{ 
        ...
        backgroundColor: ['#FFD600', '#FF4081', '#00E5FF', '#00C853', '#FFFFFF'], 
        borderColor: '#000000',
        borderWidth: 2,
        hoverOffset: 10 
      }],
        ...
        <div className="brutalist-card">
          <div className="flex items-center justify-between mb-8 pb-4 border-b-2 border-black">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 border-2 border-black bg-[var(--color-brand)] flex items-center justify-center shadow-[2px_2px_0_#000]">
                <BarChart3 className="w-5 h-5" />
              </div>
              <p className="text-sm font-black text-black uppercase tracking-widest">{t('sales_7_days')}</p>
            </div>
            <div className="text-[10px] font-black text-black border-2 border-black bg-[var(--color-brand)] px-3 py-1 shadow-[2px_2px_0_#000]">WEEKLY</div>
          </div>
        ...
        <div className="brutalist-card">
          <div className="flex items-center justify-between mb-8 pb-4 border-b-2 border-black">
            <div className="flex items-center gap-4">
              ...
              <p className="text-sm font-black text-black uppercase tracking-widest">{t('top_products')}</p>
            </div>
            <div className="text-[10px] font-black text-white border-2 border-black bg-black px-3 py-1 shadow-[2px_2px_0_#000]">MARKET</div>
          </div>
          <div className="h-[300px]">
            {topProductsData.labels.length > 0 ? (
              <Doughnut data={topProductsData} options={doughnutOptions} />
            ) : (
              <div className="h-full flex flex-col items-center justify-center gap-6 text-black opacity-50">
